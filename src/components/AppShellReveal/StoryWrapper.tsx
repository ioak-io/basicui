...
const StoryWrapper = (props: AppShellRevealProps) => {
  ...
  return (
    <AppShellReveal
      ...
      onSignout={() => {}}
    >
      <AppShellReveal.Topbar />
      <AppShellReveal.Navbar>
        <AppShellReveal.Navbar.Header>COM</AppShellReveal.Navbar.Header>
        <AppShellReveal.Navbar.Body>
        ...
        <AppShellReveal.Navbar.Footer>Navbar footer</AppShellReveal.Navbar.Footer>
      </AppShellReveal.Navbar>
      <AppShellReveal.Body>Body</AppShellReveal.Body>
      <AppShellReveal.MobileNavbar>
        <AppShellReveal.MobileNavbar.Body>
          Consectetur magni exercitationem nostrum tempora architecto quisquam
          eos qui perspiciatis ipsum non sed dicta. Ratione ipsum et minima
          quisquam quis labore ipsum aliquam ipsum commodi sed aspernatur. Ipsum
          voluptatem est quia dolores odit fugiat aut aliquid corporis veniam
        ...
        <AppShellReveal.MobileNavbar.Footer />
      </AppShellReveal.MobileNavbar>
    </AppShellReveal>
  );
};
