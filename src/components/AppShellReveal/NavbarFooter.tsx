...
const NavbarFooter = (props: NavbarFooterProps) => {
  return (
    <div
      className={`basicui-appshellreveal-navbar-footer ${
        props.isSidebarExpanded
          ? "basicui-appshellreveal-navbar-footer--expanded"
          : "basicui-appshellreveal-navbar-footer--collapsed"
      }`}
    >
      <div className="basicui-appshellreveal-navbar-footer__left">
        {props.userName && (
      ...
      {props.isSidebarExpanded && (
        <div className="basicui-appshellreveal-navbar-footer__right" onClick={props.onDarkModeToggle}>
          <svg
            aria-hidden="true"
            focusable="false"
            data-prefix="fas"
