...
const MobileNavbarFooter = (props: NavbarBodyFooterProps) => {
  return (
    <div className={`basicui-appshellreveal-mobile-navbar-footer`}>
      <div className="basicui-appshellreveal-mobile-navbar-footer__left">
        {props.userName && (
      ...
      {props.isSidebarExpanded && (
        <div
          className="basicui-appshellreveal-mobile-navbar-footer__right"
