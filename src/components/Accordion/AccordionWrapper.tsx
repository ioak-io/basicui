...
const AccordionWrapper = () => {
    ...
    return (
        <div>
            <Accordion heading="Etiam venenatis" expanded={expanded === "panel1"} onChange={() => handleChange("panel1")}>
            ...
            <Accordion heading="Lorem ipsum" expanded={expanded === "panel2"} onChange={() => handleChange("panel2")}>
            ...
            <Accordion heading="Curabitur condimentum risus pharetra diam" expanded={expanded === "panel3"} onChange={() => handleChange("panel3")}>
