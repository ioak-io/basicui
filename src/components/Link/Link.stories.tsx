...
// Create a master template for mapping args to render the Link component
...
export const DefaultLinkWthNoUnderline = Template.bind({});
DefaultLinkWthNoUnderline.args = {
  noUnderline: true,
  theme: ThemeType.default,
  label: "Lorem ipsum",
  children:
...
export const DefaultLinkWthNoGlow = Template.bind({});
DefaultLinkWthNoGlow.args = {
  noGlow: true,
  theme: ThemeType.default,
  label: "Lorem ipsum",
  children:
...
export const PrimaryLinkWthNoUnderline = Template.bind({});
PrimaryLinkWthNoUnderline.args = {
  noUnderline: true,
  theme: ThemeType.primary,
  label: "Lorem ipsum",
  children:
...
export const PrimaryLinkWthNoGlow = Template.bind({});
PrimaryLinkWthNoGlow.args = {
  noGlow: true,
  theme: ThemeType.primary,
  label: "Lorem ipsum",
  children:
